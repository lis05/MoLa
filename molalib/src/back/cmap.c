...
static map_node_t *
map_newnode(const void *key, size_t ksize, size_t koffset, const void *value, size_t vsize, size_t voffset, MapHashFunction hash_func) {
    map_node_t *node;
...
int map_from_pairs_(map_base_t *m,
                    size_t      pcount,
                    size_t      psize,
                    const void *key,
                    size_t      ksize,
